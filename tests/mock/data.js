...
// but ungenerated (the 404 that must NOT deactivate), a chain that mixes two
// languages (languageCode null), and a retraction the scenario engine can
// advance through its stages — including an unpublish (410 withdrawn).

export const SITE = 'https://example.com';

export const businesses = [
  { id: 'biz_live',  name: 'Example GmbH',            baseUrl: 'https://example.com',
    industry: { key: 'general', name: 'General' }, chainCount: 4, createdAt: '2026-03-01T10:00:00.000Z' },
...
// `declared` = declaredLanguageCodes; languageCode and urlLanguageCodes are
// derived from the url rows by the server, so the two can never disagree.
export const chains = {
  biz_live:    [
    { id: 'chain_core', name: 'Structural core', description: null, state: 'ready', declared: ['de'],
      currentStep: 9, knowledgeGraphReady: true, graphScore: 0.82, urlCount: 4, createdAt: '2026-03-02T10:00:00.000Z' },
    { id: 'chain_edit', name: 'Editorial',       description: 'Blog', state: 're_ingesting', declared: ['de'],
    ...
    { id: 'chain_en',   name: 'English site',    description: null, state: 'ready', declared: ['en'],
      currentStep: 9, knowledgeGraphReady: true, graphScore: 0.77, urlCount: 2, createdAt: '2026-06-01T10:00:00.000Z' },
    // A chain declared with two languages and holding rows in both: AIVIS
    // reports languageCode null, and the admin must decide (API-10 caveat).
    { id: 'chain_mixed', name: 'Mixed campaign', description: null, state: 'ready', declared: ['de', 'en'],
      currentStep: 9, knowledgeGraphReady: true, graphScore: 0.5, urlCount: 2, createdAt: '2026-07-01T10:00:00.000Z' },
  ],
  biz_rebuild: [
    { id: 'chain_rebuild', name: 'Rebuild', description: null, state: 'building', declared: ['de'],
      currentStep: 4, knowledgeGraphReady: false, graphScore: null, urlCount: 1, createdAt: '2026-08-21T10:00:00.000Z' },
  ],
  biz_other:   [
    { id: 'chain_other', name: 'Other', description: null, state: 'ready', declared: ['de'],
...
// `updatedAt` feeds `?updatedSince=` (API-6); scenario changes bump it.
export const urls = [
  { id: 'u_home',    businessId: 'biz_live', chainId: 'chain_core', url: 'https://example.com/',
    languageCode: 'de', layer: 'structural_core', captureStatus: 'processed', updatedAt: '2026-09-01T10:00:00.000Z',
  ...
  { id: 'u_services', businessId: 'biz_live', chainId: 'chain_core', url: 'https://example.com/services/',
    languageCode: 'de', layer: 'structural_core', captureStatus: 'processed', updatedAt: '2026-09-03T10:00:00.000Z',
  ...
  { id: 'u_services_edit', businessId: 'biz_live', chainId: 'chain_edit', url: 'https://example.com/services/',
    languageCode: 'de', layer: 'editorial', captureStatus: 'processed', updatedAt: '2026-09-04T10:00:00.000Z',
  ...
  { id: 'u_pending', businessId: 'biz_live', chainId: 'chain_core', url: 'https://example.com/kontakt/',
    languageCode: 'de', layer: 'structural_core', captureStatus: 'processing', updatedAt: '2026-09-05T10:00:00.000Z', artifact: null },
  ...
  { id: 'u_retract', businessId: 'biz_live', chainId: 'chain_core', url: 'https://example.com/altes-angebot/',
    languageCode: 'de', layer: 'editorial', captureStatus: 'processed', updatedAt: '2026-08-15T10:00:00.000Z',
  ...
  { id: 'u_en_home', businessId: 'biz_live', chainId: 'chain_en', url: 'https://example.com/en/',
    languageCode: 'en', layer: 'structural_core', captureStatus: 'processed', updatedAt: '2026-09-03T10:00:00.000Z',
  ...
  // The mixed chain: one row per language.
  { id: 'u_mixed_de', businessId: 'biz_live', chainId: 'chain_mixed', url: 'https://example.com/aktion/',
    languageCode: 'de', layer: 'editorial', captureStatus: 'processed', updatedAt: '2026-07-02T10:00:00.000Z',
    artifact: { generatedAt: '2026-07-02T10:00:00.000Z', staleAt: null, jsonLd: { '@context': 'https://schema.org', '@type': 'Offer', name: 'Aktion' } } },
  { id: 'u_mixed_en', businessId: 'biz_live', chainId: 'chain_mixed', url: 'https://example.com/en/campaign/',
    languageCode: 'en', layer: 'editorial', captureStatus: 'processed', updatedAt: '2026-07-02T10:00:00.000Z',
    artifact: { generatedAt: '2026-07-02T10:00:00.000Z', staleAt: null, jsonLd: { '@context': 'https://schema.org', '@type': 'Offer', name: 'Campaign' } } },
  ...
  { id: 'u_rebuild_home', businessId: 'biz_rebuild', chainId: 'chain_rebuild', url: 'https://example.com/rebuild-only/',
    languageCode: 'de', layer: 'structural_core', captureStatus: 'processed', updatedAt: '2026-09-05T10:00:00.000Z',
...
/** Account-wide token: reads every business on the account. */
export const VALID_TOKEN = 'aivis_' + 'M0ckT0kenForContractTestsOnly_notARealCredential1';
/** Business-bound token (API-1, contract ≥ 1.3.0): reads biz_live and nothing else. */
export const BOUND_TOKEN = 'aivis_' + 'B0undT0kenForContractTestsOnly_notARealCredential';
export const tokens = {
  [VALID_TOKEN]: { name: 'wordpress-example.com', businessId: null },
  [BOUND_TOKEN]: { name: 'wordpress-example.com (bound)', businessId: 'biz_live' },
};
