...
| Set | Issues |
|---|---|
| **For the AIVIS team** (label `for:aivis-team`) | Parent [#42](https://github.com/epoint-digital/aivis-wordpress-connector/issues/42) with native sub-issues: [#52](https://github.com/epoint-digital/aivis-wordpress-connector/issues/52) API-1 tokens · [#43](https://github.com/epoint-digital/aivis-wordpress-connector/issues/43) API-2 retraction · [#44](https://github.com/epoint-digital/aivis-wordpress-connector/issues/44) API-3 error code · [#45](https://github.com/epoint-digital/aivis-wordpress-connector/issues/45) API-4 ETag · [#46](https://github.com/epoint-digital/aivis-wordpress-connector/issues/46) API-5 per-URL inventory · [#47](https://github.com/epoint-digital/aivis-wordpress-connector/issues/47) API-6 change feed · [#48](https://github.com/epoint-digital/aivis-wordpress-connector/issues/48) API-7 rate limits · [#49](https://github.com/epoint-digital/aivis-wordpress-connector/issues/49) API-8 normalization (filed) · [#50](https://github.com/epoint-digital/aivis-wordpress-connector/issues/50) API-9 status fetch · [#51](https://github.com/epoint-digital/aivis-wordpress-connector/issues/51) API-10 chain language · [#53](https://github.com/epoint-digital/aivis-wordpress-connector/issues/53) API-11 versioning |
