...
- **No runtime API version negotiation** until API-11 ([#53](https://github.com/epoint-digital/aivis-wordpress-connector/issues/53)) and its connector counterpart ([#54](https://github.com/epoint-digital/aivis-wordpress-connector/issues/54)).
...
Open issues: https://github.com/epoint-digital/aivis-wordpress-connector/issues?q=is%3Aissue+is%3Aopen · For the AIVIS team: [#42](https://github.com/epoint-digital/aivis-wordpress-connector/issues/42) with sub-issues #52, #43–#51, #53 · Internal API tracker: [#20](https://github.com/epoint-digital/aivis-wordpress-connector/issues/20).
...
| 13 | Are the eleven API asks the right asks, at the right priority, and is anything missing? | [`API-REQUIREMENTS.md`](https://github.com/epoint-digital/aivis-wordpress-connector/blob/main/docs/API-REQUIREMENTS.md) | — | [#42](https://github.com/epoint-digital/aivis-wordpress-connector/issues/42) and sub-issues |
